...
class GameFragment : Fragment(), SensorEventListener, View.OnTouchListener{
    ...
    var enemyx = arrayOf(200f, 600f)
    var enemyy = arrayOf(1800f, 1300f)
    ...
    inner class GameView(context: Context?) : View(context) {
        ...
        override fun onDraw(canvas: Canvas) {
            ...
            with(canvas){
                ...
                drawText(""+vx, 10f, 400f,textPaint)
                drawText(""+count, 10f, 450f,textPaint)
                ...
                for(e in enemyy.indices){
                    withMatrix(viewPortMatrix) {
                        drawLine(enemyx[e],enemyy[e],enemyx[e]+200f,enemyy[e],slabPaint)
                    }
                    enemyy[e] += -8f
                    if(enemyy[e]<2f) enemyy[e] = 1800f
                }
        ...
        fun collisionDetection(){
            for(e in enemyy.indices){
                if(bally<enemyy[e]+20 && bally>enemyy[e]-20 && ballx>enemyx[e] && ballx<enemyx[e]+200f){
                    count+=1
                }
            }
        }
